...
import extraRekenopdrachten10 from '../data/extraRekenopdrachten10.js'

export default function ExtraRekenopdrachten10() {
  const opdrachten2F = extraRekenopdrachten10.filter((o) => o.niveau === '2F')
  const opdrachten3F = extraRekenopdrachten10.filter((o) => o.niveau === '3F')
