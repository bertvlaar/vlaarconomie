...
import eindquizVragen3 from '../data/eindquizVragen3.js'
...
export default function Eindquiz3() {
  return (
    <PageShell>
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-blue-700">Thema 3</p>
