...
import extraRekenopdrachten8 from '../data/extraRekenopdrachten8.js'

export default function ExtraRekenopdrachten8() {
  const opdrachten2F = extraRekenopdrachten8.filter((o) => o.niveau === '2F')
  const opdrachten3F = extraRekenopdrachten8.filter((o) => o.niveau === '3F')
