...
import eindquizVragen5 from '../data/eindquizVragen5.js'
...
export default function Eindquiz5() {
  return (
    <PageShell>
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-blue-700">Thema 5</p>
