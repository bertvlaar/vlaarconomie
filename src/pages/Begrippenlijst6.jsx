...
import begrippenThema6 from '../data/begrippenThema6.js'

export default function Begrippenlijst6() {
  return (
    <PageShell>
      ...
      <p className="mb-10 max-w-2xl text-lg text-slate-600">
        Alle belangrijke economische begrippen uit dit thema, gegroepeerd per les. Gebruik deze pagina om
        een begrip snel op te zoeken, of om je voor te bereiden op de eindquiz.
      </p>

      {begrippenThema6.map((groep) => (
