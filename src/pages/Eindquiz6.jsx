...
import eindquizVragen6 from '../data/eindquizVragen6.js'
...
export default function Eindquiz6() {
  return (
    <PageShell>
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-emerald-700">Thema 6</p>
      <h1 className="mb-3 text-slate-900">🎯 Interactieve diagnostische eindquiz</h1>
      <p className="mb-8 max-w-2xl text-slate-600">
        Test je begrip van alle vier de lessen. Klik een antwoord aan voor directe feedback. Deze quiz is
        diagnostisch: er wordt geen cijfer voor gegeven.
      </p>

      <Section>
        <div className="space-y-5">
          {eindquizVragen6.map((q, i) => (
