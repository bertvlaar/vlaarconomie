...
import extraRekenopdrachten2 from '../data/extraRekenopdrachten2.js'

export default function ExtraRekenopdrachten2() {
  const opdrachten2F = extraRekenopdrachten2.filter((o) => o.niveau === '2F')
  const opdrachten3F = extraRekenopdrachten2.filter((o) => o.niveau === '3F')
    ...
    <PageShell>
      ...
      <Section title="Niveau 3F">
        <p className="mb-4 text-sm text-slate-500">
          Verdieping: verwachte kosten bij kansen, marginale kosten en samengestelde percentageberekeningen.
        </p>
        <div className="grid gap-4 md:grid-cols-2">
          {opdrachten3F.map((r) => (
