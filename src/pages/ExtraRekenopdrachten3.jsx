...
import extraRekenopdrachten3 from '../data/extraRekenopdrachten3.js'

export default function ExtraRekenopdrachten3() {
  const opdrachten2F = extraRekenopdrachten3.filter((o) => o.niveau === '2F')
  const opdrachten3F = extraRekenopdrachten3.filter((o) => o.niveau === '3F')
    ...
    <PageShell>
      ...
      <Section title="Niveau 3F">
        <p className="mb-4 text-sm text-slate-500">
          Verdieping: Customer Lifetime Value, churn en samengestelde percentageberekeningen.
        </p>
        <div className="grid gap-4 md:grid-cols-2">
          {opdrachten3F.map((r) => (
