...
import eindquizVragen4 from '../data/eindquizVragen4.js'
...
export default function Eindquiz4() {
  return (
    <PageShell>
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-blue-700">Thema 4</p>
