...
import eindquizVragen7 from '../data/eindquizVragen7.js'
...
export default function Eindquiz7() {
  return (
    <PageShell>
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-blue-700">Thema 7</p>
