...
import eindquizVragen2 from '../data/eindquizVragen2.js'
...
export default function Eindquiz2() {
  return (
    <PageShell>
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-blue-700">Thema 2</p>
