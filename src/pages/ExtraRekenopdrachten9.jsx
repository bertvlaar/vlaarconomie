...
import extraRekenopdrachten9 from '../data/extraRekenopdrachten9.js'

export default function ExtraRekenopdrachten9() {
  const opdrachten2F = extraRekenopdrachten9.filter((o) => o.niveau === '2F')
  const opdrachten3F = extraRekenopdrachten9.filter((o) => o.niveau === '3F')
    ...
    <PageShell>
      ...
      <Section title="Niveau 3F">
        <p className="mb-4 text-sm text-slate-500">
          Verdieping: opeenvolgende percentages, rente-op-rente en samengestelde berekeningen.
        </p>
        <div className="grid gap-4 md:grid-cols-2">
          {opdrachten3F.map((r) => (
