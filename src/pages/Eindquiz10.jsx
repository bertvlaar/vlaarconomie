...
import eindquizVragen10 from '../data/eindquizVragen10.js'
...
export default function Eindquiz10() {
  return (
    <PageShell>
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-blue-700">Thema 10</p>
