...
import eindquizVragen9 from '../data/eindquizVragen9.js'
...
export default function Eindquiz9() {
  return (
    <PageShell>
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-blue-700">Thema 9</p>
