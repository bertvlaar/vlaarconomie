...
import extraRekenopdrachten1 from '../data/extraRekenopdrachten1.js'

export default function ExtraRekenopdrachten1() {
  const opdrachten2F = extraRekenopdrachten1.filter((o) => o.niveau === '2F')
  const opdrachten3F = extraRekenopdrachten1.filter((o) => o.niveau === '3F')
    ...
    <PageShell>
      ...
      <Section title="Niveau 3F">
        <p className="mb-4 text-sm text-slate-500">
          Verdieping: samengestelde interest, exponentiële groei en verhoudingen bij piramidespelen.
        </p>
        <div className="grid gap-4 md:grid-cols-2">
          {opdrachten3F.map((r) => (
