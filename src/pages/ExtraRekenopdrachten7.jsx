...
import extraRekenopdrachten7 from '../data/extraRekenopdrachten7.js'

export default function ExtraRekenopdrachten7() {
  const opdrachten2F = extraRekenopdrachten7.filter((o) => o.niveau === '2F')
  const opdrachten3F = extraRekenopdrachten7.filter((o) => o.niveau === '3F')
    ...
    <PageShell>
      ...
      <Section title="Niveau 3F">
        <p className="mb-4 text-sm text-slate-500">
          Verdieping: prijselasticiteit, opeenvolgende percentages en samengestelde berekeningen.
        </p>
        <div className="grid gap-4 md:grid-cols-2">
          {opdrachten3F.map((r) => (
