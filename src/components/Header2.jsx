...
const links = [
  { to: '/thema-2', label: 'Start' },
  { to: '/thema-2/les-2-1', label: 'Les 2.1' },
  { to: '/thema-2/les-2-2', label: 'Les 2.2' },
  { to: '/thema-2/les-2-3', label: 'Les 2.3' },
  { to: '/thema-2/les-2-4', label: 'Les 2.4' },
  { to: '/thema-2/begrippenlijst', label: 'Begrippenlijst' },
  { to: '/thema-2/extra-rekenopdrachten', label: 'Rekenopdrachten' },
  { to: '/thema-2/eindquiz', label: 'Eindquiz' },
  { to: '/thema-2/project', label: 'Project' },
  { to: '/thema-2/voor-de-docent', label: 'Voor de docent', accent: true },
]
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
      ...
      <div className="mx-auto flex max-w-[90rem] items-center gap-3 px-4 py-3 lg:px-6 xl:gap-6">
        ...
        <a
          href="/downloads/werkboek-thema2.pdf"
