...
const links = [
  { to: '/thema-9', label: 'Start' },
  { to: '/thema-9/les-9-1', label: 'Les 9.1' },
  { to: '/thema-9/les-9-2', label: 'Les 9.2' },
  { to: '/thema-9/les-9-3', label: 'Les 9.3' },
  { to: '/thema-9/les-9-4', label: 'Les 9.4' },
  { to: '/thema-9/begrippenlijst', label: 'Begrippenlijst' },
  { to: '/thema-9/extra-rekenopdrachten', label: 'Rekenopdrachten' },
  { to: '/thema-9/eindquiz', label: 'Eindquiz' },
  { to: '/thema-9/project', label: 'Project' },
  { to: '/thema-9/voor-de-docent', label: 'Voor de docent', accent: true },
]
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
      ...
      <div className="mx-auto flex max-w-[90rem] items-center gap-3 px-4 py-3 lg:px-6 xl:gap-6">
        ...
        <a
          href="/downloads/werkboek-thema9.pdf"
