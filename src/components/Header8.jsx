...
const links = [
  { to: '/thema-8', label: 'Start' },
  { to: '/thema-8/les-8-1', label: 'Les 8.1' },
  { to: '/thema-8/les-8-2', label: 'Les 8.2' },
  { to: '/thema-8/les-8-3', label: 'Les 8.3' },
  { to: '/thema-8/les-8-4', label: 'Les 8.4' },
  { to: '/thema-8/begrippenlijst', label: 'Begrippenlijst' },
  { to: '/thema-8/extra-rekenopdrachten', label: 'Rekenopdrachten' },
  { to: '/thema-8/eindquiz', label: 'Eindquiz' },
  { to: '/thema-8/project', label: 'Project' },
  { to: '/thema-8/voor-de-docent', label: 'Voor de docent', accent: true },
]
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
      ...
      <div className="mx-auto flex max-w-[90rem] items-center gap-3 px-4 py-3 lg:px-6 xl:gap-6">
        ...
        <a
          href="/downloads/werkboek-thema8.pdf"
