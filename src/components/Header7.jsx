...
const links = [
  { to: '/thema-7', label: 'Start' },
  { to: '/thema-7/les-7-1', label: 'Les 7.1' },
  { to: '/thema-7/les-7-2', label: 'Les 7.2' },
  { to: '/thema-7/les-7-3', label: 'Les 7.3' },
  { to: '/thema-7/les-7-4', label: 'Les 7.4' },
  { to: '/thema-7/begrippenlijst', label: 'Begrippenlijst' },
  { to: '/thema-7/extra-rekenopdrachten', label: 'Rekenopdrachten' },
  { to: '/thema-7/eindquiz', label: 'Eindquiz' },
  { to: '/thema-7/project', label: 'Project' },
  { to: '/thema-7/voor-de-docent', label: 'Voor de docent', accent: true },
]
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
      ...
      <div className="mx-auto flex max-w-[90rem] items-center gap-3 px-4 py-3 lg:px-6 xl:gap-6">
        ...
        <a
          href="/downloads/werkboek-thema7.pdf"
