...
const links = [
  { to: '/thema-3', label: 'Start' },
  { to: '/thema-3/les-3-1', label: 'Les 3.1' },
  { to: '/thema-3/les-3-2', label: 'Les 3.2' },
  { to: '/thema-3/les-3-3', label: 'Les 3.3' },
  { to: '/thema-3/les-3-4', label: 'Les 3.4' },
  { to: '/thema-3/begrippenlijst', label: 'Begrippenlijst' },
  { to: '/thema-3/extra-rekenopdrachten', label: 'Rekenopdrachten' },
  { to: '/thema-3/eindquiz', label: 'Eindquiz' },
  { to: '/thema-3/project', label: 'Project' },
  { to: '/thema-3/voor-de-docent', label: 'Voor de docent', accent: true },
]
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
      ...
      <div className="mx-auto flex max-w-[90rem] items-center gap-3 px-4 py-3 lg:px-6 xl:gap-6">
        ...
        <a
          href="/downloads/werkboek-thema3.pdf"
