...
const links = [
  { to: '/thema-6', label: 'Start' },
  { to: '/thema-6/les-6-1', label: 'Les 6.1' },
  { to: '/thema-6/les-6-2', label: 'Les 6.2' },
  { to: '/thema-6/les-6-3', label: 'Les 6.3' },
  { to: '/thema-6/les-6-4', label: 'Les 6.4' },
  { to: '/thema-6/begrippenlijst', label: 'Begrippenlijst' },
  { to: '/thema-6/extra-rekenopdrachten', label: 'Rekenopdrachten' },
  { to: '/thema-6/eindquiz', label: 'Eindquiz' },
  { to: '/thema-6/project', label: 'Project' },
  { to: '/thema-6/voor-de-docent', label: 'Voor de docent', accent: true },
]
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
      ...
      <div className="mx-auto flex max-w-[90rem] items-center gap-3 px-4 py-3 lg:px-6 xl:gap-6">
        ...
        <a
          href="/downloads/werkboek-thema6.pdf"
