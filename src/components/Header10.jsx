...
const links = [
  { to: '/thema-10', label: 'Start' },
  { to: '/thema-10/les-10-1', label: 'Les 10.1' },
  { to: '/thema-10/les-10-2', label: 'Les 10.2' },
  { to: '/thema-10/les-10-3', label: 'Les 10.3' },
  { to: '/thema-10/les-10-4', label: 'Les 10.4' },
  { to: '/thema-10/begrippenlijst', label: 'Begrippenlijst' },
  { to: '/thema-10/extra-rekenopdrachten', label: 'Rekenopdrachten' },
  { to: '/thema-10/eindquiz', label: 'Eindquiz' },
  { to: '/thema-10/project', label: 'Project' },
  { to: '/thema-10/voor-de-docent', label: 'Voor de docent', accent: true },
]
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
      ...
      <div className="mx-auto flex max-w-[90rem] items-center gap-3 px-4 py-3 lg:px-6 xl:gap-6">
        ...
        <a
          href="/downloads/werkboek-thema10.pdf"
